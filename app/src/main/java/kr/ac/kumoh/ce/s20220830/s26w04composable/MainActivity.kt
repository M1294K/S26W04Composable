package kr.ac.kumoh.ce.s20220830.s26w04composable
...
import kr.ac.kumoh.ce.s20220830.s26w04composable.ui.theme.S26W04ComposableTheme
...
fun MainScreen() {
    ...
    val modifiers = remember {
        listOf(
            ...
            Modifier.background(Color(0xFF83A598))
        )
    }
